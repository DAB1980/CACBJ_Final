...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-06-2024 a las 04:49:25
...
--
-- Base de datos: `bd_codoacodo`
--
CREATE DATABASE IF NOT EXISTS `bd_codoacodo` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `bd_codoacodo`;
...
INSERT INTO `usuarios` (`id`, `name`, `age`) VALUES
(1, 'david', 44),
(2, 'marina', 30);
...
--
CREATE DATABASE IF NOT EXISTS `cac_bj_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `cac_bj_db`;
...
-- Base de datos: `pepe`
--
CREATE DATABASE IF NOT EXISTS `pepe` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `pepe`;
--
...
('root', '[{\"db\":\"cac_bj_db\",\"table\":\"noticias\"},{\"db\":\"cac_bj_db\",\"table\":\"socios\"},{\"db\":\"cac_bj_db\",\"table\":\"users\"},{\"db\":\"cac_bj_db\",\"table\":\"plantel_fm\"},{\"db\":\"bd_codoacodo\",\"table\":\"usuarios\"}]');
...
('root', '2024-06-28 00:41:03', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
